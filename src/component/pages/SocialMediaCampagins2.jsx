...
const defaultFormData = { referenceNumber: "", leadStatus: "", firstName: "Jessica", lastName: "Turner", company: "Hartmann LLC", email: "jessica.turner@example.org", website: "https://hartmann.com", phone: "+14085559821" };
...
export default function SocialMediaCampaigns2() {
    ...
    <div className="p-4 md:p-6 bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-6">
        ...
        <div className="flex gap-2 flex-shrink-0">
          <button onClick={() => navigate("/socialmedia")} className="bg-yellow-400 hover:bg-yellow-500 px-3 md:px-4 py-2 rounded text-white text-sm">← Previous Lead</button>
          <button disabled className="bg-green-500 opacity-50 cursor-not-allowed px-3 md:px-4 py-2 rounded text-white text-sm">Next Lead →</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="text-sm space-y-2 text-gray-600">
            <p>Lead Number : <b>69 / 97</b></p><p>Last Actioner : <b>Admin</b></p><p>Follow Up : <b>-</b></p><p>Salesman Booking : <b>-</b></p>
          </div>
        </div>
                ...
                <table className="w-full border min-w-[500px]">
                  ...
                  <tbody>
                    {callLogs.length > 0
                      ...
                      : <tr><td className="p-2 border text-sm">17 M, 45 S</td><td className="p-2 border text-sm">04-03-2026 11:00 am</td><td className="p-2 border text-sm">Admin</td></tr>
                    }
                  </tbody>
                </table>
              </div>
