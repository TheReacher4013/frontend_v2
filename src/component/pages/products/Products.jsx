...
function Products() {
  ...
  const handleSaveProduct = async () => {
    ...
    try {
      const payload = { name: formData.name, type: formData.type, price: formData.price, tax_label: formData.taxLabel, tax_rate: formData.taxRate, logo: formData.logo };
  ...
  const deleteProduct = async (id) => {
    if (window.confirm("Delete this product?")) {
      try { await api.deleteProduct(id); await loadProducts(); }
